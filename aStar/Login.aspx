...
<%--						<button class="login100-form-btn">
                        ...
                        <asp:Button ID="Button1" class="login100-form-btn" runat="server" Text="Sign in" OnClick="Button1_Click" />
					</div>
				...
				<div class="login100-more" style="background-image: url('imagess/bg-01.jpg');"></div>
			</div>
		</div>
	</div>
