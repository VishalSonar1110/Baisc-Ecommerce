<%@ Page Title="" Language="C#" MasterPageFile="~/HomePage.master" AutoEventWireup="true" CodeFile="Clothes.aspx.cs" Inherits="Clothes" %>

<%@ Register Src="~/ClothesMenuControl.ascx" TagPrefix="uc1" TagName="ClothesMenuControl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <form id="form1" runat="server">
        <table class="w-100">
            ...
            <tr>
                   <td style="height: 34px"></td>
                <td style="height: 115px; width: 693px;"><uc1:ClothesMenuControl runat="server" ID="ClothesMenuControl" /></td>
